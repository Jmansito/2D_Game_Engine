...
public class MouseListener {
    ...
    // initialize the mouse positions to avoid errors on startup
    ...
    // Listener for the mouse and getting the input
    ...
    public static void mouseButtonCallback(long window, int button, int action, int mods){
        if(action == GLFW_PRESS){
            // Check for more buttons than our buttons array allows for
